...
Keep the application label **Material Design**, namespace/application ID `dev.qtremors.materialdesign`, and public version `2.0.6` unless an explicit version change is requested. Update `CHANGELOG.md` for every user-visible change.
