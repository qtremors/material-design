...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-2.0.5-blueviolet" alt="Project version 2.0.5">
</p>
...
|---------|---------|--------|
| [`material-app/`](material-app/) | Searchable Material Design gallery and modular Compose source reference | 2.0.5, active |
...
|---------|---------|--------------------|
| Android app | 2.0.5, active | [APK releases](https://github.com/qtremors/material-design/releases) |
| Web documentation | 2.0.5 | [Live documentation](https://qtremors.github.io/material-design/) |
