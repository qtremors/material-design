...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-2.0.0-blueviolet" alt="Project version 2.0.0">
</p>
...
|---------|---------|--------|
| [`material-app/`](material-app/) | Searchable Material Design gallery and modular Compose source reference | 2.0.0, active |
...
|---------|---------|--------------------|
| Android app | 2.0.0, WIP | [APK releases](https://github.com/qtremors/material-design/releases) |
| Web documentation | 2.0.0 | [Live documentation](https://qtremors.github.io/material-design/) |
...
Current working references include Buttons, Split buttons, Floating action buttons, Progress indicators, Segmented list items, Carousels, Floating toolbars, and Typography. The adaptive shell provides Explore, Catalog, APIs, and Foundations destinations plus local bookmarks, recent history, theme, dynamic-color, and reduced-motion settings.
